...
title: Steel Block
heading: Steel Block
description: "[node][default:steelblock]"
permalink: /items/default-steelblock/
icon: /items/itemcubes/default_steelblock.png
---
...
<ul class="list-items clearfix">
    <li>ZZZdefault:steel_ingot (missing item)</li>
