...
<div class="craft">
    <div>
        <span><a href="{{site.baseurl}}/items/group-flower,color-white/"><img src="{{site.baseurl}}/assets/img/items/group.png" data-toggle="tooltip" title="Group Flower,color White [group][flower,color_white]"></a></span>
        <span></span>
        <span></span>
    </div>
    <div>
