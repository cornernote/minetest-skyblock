...
<div class="craft">
    <div>
        <span><a href="{{site.baseurl}}/items/group-flower,color-yellow/"><img src="{{site.baseurl}}/assets/img/items/group.png" data-toggle="tooltip" title="Group Flower,color Yellow [group][flower,color_yellow]"></a></span>
        <span></span>
        <span></span>
    </div>
    <div>
