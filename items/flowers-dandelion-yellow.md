...
<ul class="list-items">
    ...
    <li><a href="{{site.baseurl}}/items/group-color-yellow/"><img src="{{site.baseurl}}/assets/img/items/itemcubes/flowers_dandelion_yellow.png" data-toggle="tooltip" title="Group Color Yellow [group][color_yellow]"></a></li>
