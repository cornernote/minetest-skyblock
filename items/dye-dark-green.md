...
<div class="craft">
    <div>
        <span><a href="{{site.baseurl}}/items/group-flower,color-dark-green/"><span class="item-group" data-toggle="tooltip" title="Group Flower,color Dark Green [group][flower,color_dark_green]"><img src="{{site.baseurl}}/assets/img/transparent.png"><img src="{{site.baseurl}}/assets/img/transparent.png"><img src="{{site.baseurl}}/assets/img/transparent.png"></span></a></span>
        <span></span>
        <span></span>
    </div>
    <div>
...
<ul class="list-items clearfix">
    <li><a href="{{site.baseurl}}/items/group-basecolor-green/"><span class="item-group" data-toggle="tooltip" title="Group Basecolor Green [group][basecolor_green]"><img src="{{site.baseurl}}/assets/img/items/textures/dye_dark_green.png"><img src="{{site.baseurl}}/assets/img/items/textures/dye_green.png"><img src="{{site.baseurl}}/assets/img/transparent.png"></span></a></li>
    ...
    <li><a href="{{site.baseurl}}/items/group-excolor-green/"><span class="item-group" data-toggle="tooltip" title="Group Excolor Green [group][excolor_green]"><img src="{{site.baseurl}}/assets/img/items/textures/dye_dark_green.png"><img src="{{site.baseurl}}/assets/img/items/textures/dye_green.png"><img src="{{site.baseurl}}/assets/img/transparent.png"></span></a></li>
    <li><a href="{{site.baseurl}}/items/group-unicolor-dark-green/"><span class="item-group" data-toggle="tooltip" title="Group Unicolor Dark Green [group][unicolor_dark_green]"><img src="{{site.baseurl}}/assets/img/items/textures/dye_dark_green.png"><img src="{{site.baseurl}}/assets/img/transparent.png"><img src="{{site.baseurl}}/assets/img/transparent.png"></span></a></li>
</ul>
