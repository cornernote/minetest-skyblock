...
<ul class="list-items">
    ...
    <li><a href="{{site.baseurl}}/items/group-pane/"><img src="{{site.baseurl}}/assets/img/items/itemcubes/xpanes_bar.png" data-toggle="tooltip" title="Group Pane [group][pane]"></a></li>
