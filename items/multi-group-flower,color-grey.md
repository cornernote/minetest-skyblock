---
layout: default
title: MultiGroup: Flower + Color Grey
heading: MultiGroup: Flower + Color Grey
description: "[group][flower,color_grey]"
permalink: /items/group-flower,color-grey/
---
...
<ul class="list-items clearfix">
    ...
    <li><a href="{{site.baseurl}}/items/group-color-grey/"><span class="item-group" data-toggle="tooltip" title="Group Color Grey [group][color_grey]"><img src="{{site.baseurl}}/assets/img/transparent.png"><img src="{{site.baseurl}}/assets/img/transparent.png"><img src="{{site.baseurl}}/assets/img/transparent.png"></span></a></li>
</ul>
