---
layout: default
title: MultiGroup: Flower + Color Magenta
heading: MultiGroup: Flower + Color Magenta
description: "[group][flower,color_magenta]"
permalink: /items/group-flower,color-magenta/
---
...
<ul class="list-items clearfix">
    ...
    <li><a href="{{site.baseurl}}/items/group-color-magenta/"><span class="item-group" data-toggle="tooltip" title="Group: Color Magenta [group][color_magenta]"><img src="{{site.baseurl}}/assets/img/transparent.png"><img src="{{site.baseurl}}/assets/img/transparent.png"><img src="{{site.baseurl}}/assets/img/transparent.png"></span></a></li>
</ul>
