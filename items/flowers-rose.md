...
<ul class="list-items">
    ...
    <li><a href="{{site.baseurl}}/items/group-color-red/"><img src="{{site.baseurl}}/assets/img/items/group.png" data-toggle="tooltip" title="Group Color_red [group][color_red]"></a></li>
