...
<ul class="list-items">
    ...
    <li><a href="{{site.baseurl}}/items/group-color-red/"><img src="{{site.baseurl}}/assets/img/items/itemcubes/flowers_rose.png" data-toggle="tooltip" title="Group Color Red [group][color_red]"></a></li>
