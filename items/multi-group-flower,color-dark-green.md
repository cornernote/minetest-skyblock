---
layout: default
title: MultiGroup: Flower + Color Dark Green
heading: MultiGroup: Flower + Color Dark Green
description: "[group][flower,color_dark_green]"
permalink: /items/group-flower,color-dark-green/
---
...
<ul class="list-items clearfix">
    ...
    <li><a href="{{site.baseurl}}/items/group-color-dark-green/"><span class="item-group" data-toggle="tooltip" title="Group: Color Dark Green [group][color_dark_green]"><img src="{{site.baseurl}}/assets/img/transparent.png"><img src="{{site.baseurl}}/assets/img/transparent.png"><img src="{{site.baseurl}}/assets/img/transparent.png"></span></a></li>
</ul>
